...
celery -A app.workers.celery_app worker --loglevel=info -Q payout,oracle,vov,default --pool=solo

# Terminal 3 — Monday worker (dedicated, concurrency=1)
celery -A app.workers.celery_app worker --loglevel=info -Q monday --concurrency=1
